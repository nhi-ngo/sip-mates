...
//  SipMates
//
//  Created by Nhi Ngo on 12/15/24.
//
...
struct AlertContext {
    ...
    static let locationDenied                   = AlertItem(title: Text("Locations Denied"),
                                                            message: Text("SipMates does not have permission to access your location. To change that go to your phone's Settings > SipMates > Location"),
                                                            dismissButton: .default(Text("Ok")))
    ...
    static let noUserRecord                     = AlertItem(title: Text("No User Record"),
                                                            message: Text("You must log into iCloud on your phone in order to utilize SipMates's Profile. Please log in on your phone's settings screen."),
                                                            dismissButton: .default(Text("Ok")))
    ...
    static let updateProfileSuccess             = AlertItem(title: Text("Profile Update Success!"),
                                                            message: Text("Your SipMates profile was updated successfully"),
